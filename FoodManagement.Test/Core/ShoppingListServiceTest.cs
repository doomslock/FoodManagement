...
namespace FoodManagement.Test
{
    ...
    public class ShoppinglistServiceTest
    {
        ...
        public void Initialize()
        {
            ...
            pRepMock.Setup(m => m.GetById(It.IsAny<Guid>(), "")).Returns((Guid g, string s) => g == currentUser.Id ? currentUser : null);
            ...
            fRepMock.Setup(m => m.GetById(It.IsAny<Guid>(), It.IsAny<string>())).Returns((Guid g, string s) => familyList.First(f => f.Id == g));
